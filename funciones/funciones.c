...
//usaremos esta funci�n para pasar los alfanum�ricos a int
void auxiliar(){
...
int validar_ip(char ip[]){
    ...
    //Usamos la funci�n atoi para transformar el valor alfanum�rico a num�rico para poder
    ...
    //devolvemos un valor distinto a 0 si la IP no es v�lida
}

int validar_puerto(int puerto){
    //Los puertos válidos se encuentran en el rango de 1-65535
    if(puerto > 0 && puerto <= 65535){
        return 0;
    } else return 1;
    //devolvemos un valor distinto a 0 si el puerto no es v�lido
}
